...
class AddonUpdaterUpdateNow(bpy.types.Operator):
    ...
    bl_description = f"Update to the latest version of the {updater.addon} addon"
    bl_options = {'REGISTER', 'INTERNAL'}
...
class AddonUpdaterUpdateTarget(bpy.types.Operator):
    ...
    bl_description = f"Install a targeted version of the {updater.addon} addon"
    bl_options = {'REGISTER', 'INTERNAL'}
...
def register():
    ...
    updater.repo = "marimo-blender"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/iplai/marimo-blender"
